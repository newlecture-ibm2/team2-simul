...
| 이슈 | ID | 상태 | 설명 |
|---|---|---|---|
| SCRUM-140 | FEED-002 | 🔄 진행 중 | 게시물 작성 API 구현 (4점) |
| SCRUM-143 | FEED-003 | ⬚ 대기 | 피드 목록 조회 API 구현 (4점) |
| SCRUM-156 | FEED-016 | ⬚ 대기 | 홈 피드 페이지 구현 (4점) |
...
## 7. 기능 검증 및 배포 프로세스 (Testing & Deployment Standard)
